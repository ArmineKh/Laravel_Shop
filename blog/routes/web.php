...
Route:: get('/editProfile','User@edit1')->middleware('chackLogin'); 
Route::post('/edit','User@edit')->middleware('chackLogin');
...
Route::get("/admin", 'Admin@isadmin');
Route::get("/block/{id}","Admin@blockUser");
Route::get("/activ/{id}","Admin@activProduct"); 
 
Route::post("/blockd","Admin@blockd");
...
Route::get("/orders", "OrderController@show")->middleware('chackLogin');
Route::get("/orderdetails/{id}","OrderController@details")->middleware('chackLogin');
Route::post("/fedback","OrderController@fedback")->middleware('chackLogin');
Route::get("/seefedbacks/{id}","ProductController@fedbacks")->middleware('chackLogin'); 
